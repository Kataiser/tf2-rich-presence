...
gamemodes = {'Capture the Flag': 'ctf', 'Control Point': 'control-point', 'Attack/Defend': 'attack-defend', 'Attack/Defend (Medieval Mode)': 'medieval-mode',
             ...
             'Arena': 'arena', 'Training Mode': 'training', 'Developer aidTest': 'unknown_map', 'Developer aidControl Point': 'unknown_map'}
map_gamemodes = {}
...
for tr in soup.find_all('tr'):
    ...
    if map_mode and map_name:
        ...
        gamemode_replacements = [('d(M', 'd (M'), ('t(D', 't (D'), (' Mode', ''), ('Developer aidTest', 'No gamemode'), ('Developer aidControl Point', 'No gamemode')]
        for replacemment in gamemode_replacements:
            print(gamemode_fancy, replacemment)
