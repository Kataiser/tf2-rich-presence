...
## Download
With 7-Zip's built-in extractor: [tf2_rich_presence_v1.14.3_self_extracting.exe](https://github.com/Kataiser/tf2-rich-presence/releases/download/v1.14.3/tf2_rich_presence_v1.14.3_self_extracting.exe) (8.1 MB)  
Extract it yourself: [tf2_rich_presence_v1.14.3.zip](https://github.com/Kataiser/tf2-rich-presence/releases/download/v1.14.3/tf2_rich_presence_v1.14.3.zip) (11.2 MB)

## Installation and running
1. Extract `tf2_rich_presence_v1.14.3.zip` OR run `tf2_rich_presence_v1.14.3_self_extracting.exe`, whichever you downloaded.
