...
Installer: [TF2RichPresence_v2.2.1_setup](https://github.com/Kataiser/tf2-rich-presence/releases/download/v2.2.1/TF2RichPresence_v2.2.1_setup.exe) (19.0 MB)  
Alternatively, get the latest autobuild (may be untested/buggy): [TF2RichPresence_v2.2.1_setup](https://nightly.link/Kataiser/tf2-rich-presence/workflows/Tests.CD/master/TF2RichPresence_v2.2.1_setup.exe.zip)  
