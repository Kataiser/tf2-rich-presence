...
## Download
With 7-Zip's built-in extractor: [tf2_rich_presence_v1.14.1_self_extracting.exe](https://github.com/Kataiser/tf2-rich-presence/releases/download/v1.14.1/tf2_rich_presence_v1.14.1_self_extracting.exe) (8.1 MB)  
