...
Installer: [TF2RichPresence_v2.2_setup](https://github.com/Kataiser/tf2-rich-presence/releases/download/v2.2/TF2RichPresence_v2.2_setup.exe) (20.7 MB)  
Alternatively, get the latest autobuild (may be untested/buggy): [TF2RichPresence_v2.2_setup](https://nightly.link/Kataiser/tf2-rich-presence/workflows/Tests.CD/master/TF2RichPresence_v2.2_setup.exe.zip)  
