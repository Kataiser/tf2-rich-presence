...
Installer: [TF2RichPresence_v2.1.6_setup](https://github.com/Kataiser/tf2-rich-presence/releases/download/v2.1.6/TF2RichPresence_v2.1.6_setup.exe) (16.8 MB)  
Alternatively, get the latest autobuild (may be untested/buggy): [TF2RichPresence_v2.1.6_setup](https://nightly.link/Kataiser/tf2-rich-presence/workflows/Tests.CD/master/TF2RichPresence_v2.1.6_setup.exe.zip)  
