...
Installer: [TF2RichPresence_v2.1.5_setup](https://github.com/Kataiser/tf2-rich-presence/releases/download/v2.1.5/TF2RichPresence_v2.1.5_setup.exe) (16.6 MB)  
Alternatively, get the latest autobuild (may be untested/buggy): [TF2RichPresence_v2.1.5_setup](https://nightly.link/Kataiser/tf2-rich-presence/workflows/Tests.CD/master/TF2RichPresence_v2.1.5_setup.exe.zip)  
