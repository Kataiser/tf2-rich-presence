...
Installer: [TF2RichPresence_v2.2.3_setup](https://github.com/Kataiser/tf2-rich-presence/releases/download/v2.2.3/TF2RichPresence_v2.2.3_setup.exe) (19.1 MB)  
Alternatively, get the latest autobuild (may be untested/buggy): [TF2RichPresence_v2.2.3_setup](https://nightly.link/Kataiser/tf2-rich-presence/workflows/Tests.CD/master/TF2RichPresence_v2.2.3_setup.exe.zip)  
