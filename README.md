...
Installer: [TF2RichPresence_v2.2.4_setup](https://github.com/Kataiser/tf2-rich-presence/releases/download/v2.2.4/TF2RichPresence_v2.2.4_setup.exe) (19.4 MB)  
Alternatively, get the latest autobuild (may be untested/buggy): [TF2RichPresence_v2.2.4_setup](https://nightly.link/Kataiser/tf2-rich-presence/workflows/Tests.CD/master/TF2RichPresence_v2.2.4_setup.exe.zip)  
