...
Installer: [TF2RichPresence_v2.1.3_setup](https://github.com/Kataiser/tf2-rich-presence/releases/download/v2.1.3/TF2RichPresence_v2.1.3_setup.exe) (14.3 MB)  
Alternatively, get the latest autobuild (may be untested/buggy): [TF2RichPresence_v2.1.3_setup](https://nightly.link/Kataiser/tf2-rich-presence/workflows/Tests.CD/master/TF2RichPresence_v2.1.3_setup.exe.zip)  
