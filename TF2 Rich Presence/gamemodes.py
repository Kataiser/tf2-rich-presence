...
modes: Dict[str, str] = {'ctf': 'Capture the Flag', 'control-point': 'Control Point', 'attack-defend': 'Attack/Defend', 'medieval-mode': 'Attack/Defend (Medieval Mode)',
                         ...
                         'dodgeball': 'Dodgeball', 'zombie': 'Zombie Infection', 'mario-kart': 'Mario Kart', 'prophunt': 'Prop Hunt', 'mge-mod': 'MGE Mod', 'tug-of-war': 'Tug of War', 'vip': 'VIP'}
...
prefixes: Dict[str, str] = {'ctf': 'ctf', 'tc': 'territorial-control', 'pl': 'payload', 'plr': 'payload-race', 'koth': 'koth', 'sd': 'special-delivery', 'mvm': 'mvm', 'rd': 'beta-map',
                            ...
                            'mario': 'mario-kart', 'ph': 'prophunt', 'mge': 'mge-mod', 'zi': 'zombie', 'tow': 'tug-of-war', 'vip': 'vip', '2koth': 'koth'}
...
localization_excluded: tuple[str, ...] = ('surfing', 'trading', 'jumping', 'deathmatch', 'cp-orange', 'deathrun', 'achievement', 'breakout', 'slender', 'dodgeball', 'zombie', 'mario-kart',
                                          'prophunt', 'mge-mod')
