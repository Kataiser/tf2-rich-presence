...
if __name__ == '__main__':
    ...
    ci_tests = [f_tests.test_interpret_console_log, f_tests.test_steam_config_file, f_tests.test_logger, f_tests.test_log_cleanup, f_tests.test_generate_hash, f_tests.test_read_truncated_file,
                f_tests.test_pastebin, f_tests.test_access_github_api, f_tests.test_settings_check_int, f_tests.test_settings_access, f_tests.test_get_api_key, f_tests.test_compact_file,
                f_tests.test_generate_delta, f_tests.test_get_info_from_pid]
