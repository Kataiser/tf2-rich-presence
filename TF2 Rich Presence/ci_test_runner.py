...
if __name__ == '__main__':
    ...
    ci_tests = [f_tests.test_interpret_console_log, f_tests.test_steam_config_file, f_tests.test_logger, f_tests.test_generate_hash, f_tests.test_read_truncated_file,
